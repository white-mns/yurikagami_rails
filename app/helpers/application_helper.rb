module ApplicationHelper
    ...
    def character_link(e_no, sub_no)
        ...
        link_to " 最終キャラ結果", "https://archives.teiki.org/yk/3/turn94/status"+file_name+".html", :target => "_blank"
    end
    ...
    def battle_link(party_no)
        ...
        link_to " 最終戦闘結果", "https://archives.teiki.org/yk/3/turn94/result"+file_name+".html", :target => "_blank"
    end
