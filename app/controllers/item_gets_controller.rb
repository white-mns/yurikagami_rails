class ItemGetsController < ApplicationController
  ...
  def index
    param_set
    @count	= ItemGet.includes([:p_name]).search(params[:q]).result.count()
    @search	= ItemGet.includes([:p_name]).page(params[:page]).search(params[:q])
  ...
  def param_set
    ...
    reference_text_assign(params, "p_name_name", "p_name_form")
        ...
        reference_number_assign(params, "item", "item_form")
