class ProfilesController < ApplicationController
  ...
  def param_set
    ...
    params_to_form(params, @form_params, column_name: "job", params_name: "job_form", type: "text")
    params_to_form(params, @form_params, column_name: "sex", params_name: "sex_form", type: "text")
    params_to_form(params, @form_params, column_name: "age", params_name: "age_form", type: "text")
    params_to_form(params, @form_params, column_name: "height", params_name: "height_form", type: "text")
    params_to_form(params, @form_params, column_name: "weight", params_name: "weight_form", type: "text")
