...
class PartiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create party" do
    assert_difference('Party.count') do
      post parties_url, params: { party: { e_no: @party.e_no, generate_no: @party.generate_no, party_no: @party.party_no, result_no: @party.result_no, sub_no: @party.sub_no } }
    end
  ...
  test "should update party" do
    patch party_url(@party), params: { party: { e_no: @party.e_no, generate_no: @party.generate_no, party_no: @party.party_no, result_no: @party.result_no, sub_no: @party.sub_no } }
