...
ActiveRecord::Schema.define(version: 2020_05_25_003515) do
  ...
  create_table "smiths", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.integer "result_no"
    t.integer "generate_no"
    t.integer "last_result_no"
    t.integer "last_generate_no"
